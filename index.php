...
<html>
    ...
    <body>
        ...
        <?php
        include './Diseños/tablaprecios.php';
        ?>
        <section class="mosaico">
            <h2>Algunos de los 20+ juegos que ofrecemos</h2>
            <div class="img-juegos">
                <img src="img/pacman.webp" alt="pacman">
                <img src="img/pacman.webp" alt="pacman">
                <img src="img/pacman.webp" alt="pacman">
                <img src="img/pacman.webp" alt="pacman">
                <img src="img/pacman.webp" alt="pacman">
...
<?php
include './Diseños/formulario.php';
?>
</body>
<?php
